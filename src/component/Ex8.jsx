...
const numReducer = (state, action) => {
    ...
    switch(action){
        case 'plus' : return { num : state.num + 1 }
        break;
        case 'minus' : if(state.num > 0){
    ...
    <div className='container'>
      <div className="row">
        <div className="col-md-12 text-center">
            <h3 className="display3 text-success">useReducer</h3>
        </div>
      </div>
      <div className="row">
        <div className="col-md-12">
            <h3 className="display3 text-center text-danger">Num = {state.num} </h3>
            <hr />
